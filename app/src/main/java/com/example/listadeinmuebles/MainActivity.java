...
public class MainActivity extends AppCompatActivity {
    ...
    public void cargarDatos(){
        lista.add(new Inmueble(R.drawable.casa1,"Juana Koslay",750000));
        lista.add(new Inmueble(R.drawable.casa2,"Protrero",1250000));
        lista.add(new Inmueble(R.drawable.casa3,"La Punta",550000));
    }
}
